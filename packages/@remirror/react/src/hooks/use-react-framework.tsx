...
/**
 * The hook responsible for providing the editor context to the
 * `Remirror` and the `useRemirrorExperimental`.
 *
 * @remarks
 *
 * This is an internal hook which exposes the `ReactFramework` instance as a
 * hook which can be consumed by the public API's. It is used in both the
 * `useRemirrorExperimental` and the `Remirror`.
 *
 * @internal
 */
