...
export const IMPORT_CACHE: { [moduleName: string]: any } = {
  ...
  'remirror/presets': require('remirror/presets'),
  ...
  '@remirror/preset-core': require('remirror/presets'),
  '@remirror/preset-embed': require('remirror/presets'),
  '@remirror/preset-list': require('remirror/presets'),
  '@remirror/preset-react': require('remirror/presets'),
  '@remirror/preset-social': require('remirror/presets'),
  '@remirror/preset-table': require('remirror/presets'),
  '@remirror/preset-wysiwyg': require('remirror/presets'),
  '@remirror/react': require('remirror/react'),
