...
import type { AnyExtension, MakeOptional } from '@remirror/core';
...
import { useManager, useRemirrorContext } from './hooks';
...
import type { CreateReactManagerOptions, I18nContextProps } from './react-types';
